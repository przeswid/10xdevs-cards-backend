...
**GDPR Compliance:**
- Account deletion triggers CASCADE DELETE for all related data
- Complete data removal within 30 days as required by GDPR
- No soft delete approach to ensure "right to be forgotten"
